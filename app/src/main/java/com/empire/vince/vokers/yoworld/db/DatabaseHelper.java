...
{
    private static final String DATABASE_NAME = YoWorldConfig.DATABASE_NAME;
    private static final String DATABASE_PATH = "/data/data/" + YoWorldApplication.getContext().getPackageName() + "/databases/";
    private static final int DATABASE_VERSION = YoWorldConfig.DATABASE_VERSION;
    ...
    {
        super(YoWorldApplication.getContext(), DATABASE_PATH + DATABASE_NAME, null, DATABASE_VERSION);
    ...
    private boolean copyPrepopulatedDatabase()
    {
        ...
        try
        {
            ...
            // create streams
            InputStream inputStream = YoWorldApplication.getContext().getAssets().open(DATABASE_NAME);
    ...
    {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(YoWorldApplication.getContext());
