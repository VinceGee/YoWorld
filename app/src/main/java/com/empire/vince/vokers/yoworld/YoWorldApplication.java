 ...
 */
public class YoWorldApplication extends Application
{
    private static YoWorldApplication mInstance;

    private Tracker mTracker;


    public YoWorldApplication()
    {
        mInstance = this;
    }
    ...
    public synchronized Tracker getTracker()
    {
        if(mTracker==null)
        {
            ...
            analytics.setDryRun(!YoWorldConfig.ANALYTICS);
