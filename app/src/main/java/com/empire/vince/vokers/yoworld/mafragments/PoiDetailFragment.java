...
import com.empire.vince.vokers.yoworld.db.queries.PoiReadQuery;
...
import com.empire.vince.vokers.yoworld.utilities.ResourcesHelper;
import com.empire.vince.vokers.yoworld.view.ObservableStickyScrollView;
...
public class PoiDetailFragment extends TaskFragment implements DatabaseCallListener, GeolocationListener
{
    ...
    private void renderViewBanner()
    {
        ...
        // admob
        if(YoWorldConfig.ADMOB_POI_DETAIL_BANNER && NetworkManager.isOnline(getActivity()))
        {
