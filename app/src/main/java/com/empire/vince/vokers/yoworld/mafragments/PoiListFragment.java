...
import com.empire.vince.vokers.yoworld.adapter.PoiListAdapter;
import com.empire.vince.vokers.yoworld.adapter.SearchSuggestionAdapter;
import com.empire.vince.vokers.yoworld.content.PoiSearchRecentSuggestionsProvider;
...
import com.empire.vince.vokers.yoworld.db.queries.PoiReadByCategoryQuery;
import com.empire.vince.vokers.yoworld.db.queries.PoiReadFavoritesQuery;
import com.empire.vince.vokers.yoworld.db.queries.PoiSearchQuery;
import com.empire.vince.vokers.yoworld.db.queries.Query;
import com.empire.vince.vokers.yoworld.dialogs.AboutDialogFragment;
import com.empire.vince.vokers.yoworld.geolocation.Geolocation;
import com.empire.vince.vokers.yoworld.geolocation.GeolocationListener;
import com.empire.vince.vokers.yoworld.listener.OnSearchListener;
...
import com.empire.vince.vokers.yoworld.view.GridSpacingItemDecoration;
...
public class PoiListFragment extends TaskFragment implements DatabaseCallListener, GeolocationListener, PoiListAdapter.PoiViewHolder.OnItemClickListener
{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.menu_rate:
                startWebActivity(getString(R.string.app_store_uri, YoWorldApplication.getContext().getPackageName()));
                return true;
    ...
    private void renderView()
    {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                mActionMode = ((AppCompatActivity) getActivity()).getSupportActionBar().startActionMode(new SearchActionModeCallback());
            }
        });

        // admob
        if(YoWorldConfig.ADMOB_POI_LIST_BANNER && NetworkManager.isOnline(getActivity()))
        {
